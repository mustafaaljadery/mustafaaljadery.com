...
export const HomepageHeader = () => {
  ...
  return (
    <div className="flex flex-col bg-white justify-center items-center w-full py-[21px] sticky top-0">
...
export const Header = () => {
  ...
  return (
    <div className="flex flex-col bg-white justify-center items-center w-full py-4 sticky top-0">
